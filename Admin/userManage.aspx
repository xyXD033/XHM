                ...
                <tr >
                    <td align="left" style="height: 100%">
                        <asp:GridView ID="gvUser" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="gvUser_RowDeleting"
                            Width="100%">
                            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                            <Columns>
                                <asp:BoundField DataField="userName" HeaderText="账号" />
                                <asp:BoundField DataField="userPwd" HeaderText="密码" />
                                <asp:BoundField DataField="PowerName" HeaderText="用户角色" />
                                <asp:TemplateField HeaderText="修改">
                                    <ItemTemplate>
                                      <a class="huise1" href="#" onclick="window.open('addUser.aspx?userId=<%#Eval("userId") %>','','width=400,height=300')">
                                        修改</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
