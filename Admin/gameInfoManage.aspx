<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gameInfoManage.aspx.cs" Inherits="Admin_gameInfoManage" %>
            ...
            <table align="center"  border="0" cellpadding="5" cellspacing="1"
                ...
                <tr >
                    <td align="left" style="height: 100%">
                                           <asp:GridView ID="gvGameManage" runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True"  OnPageIndexChanging="gvGameManage_PageIndexChanging" OnRowDeleting="gvGameManage_RowDeleting" onrowdatabound="gvGameManage_RowDataBound" CellPadding="4" GridLines="None" PageSize="15">
