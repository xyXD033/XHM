<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gameReturnSearch.aspx.cs" Inherits="GameManger_gameReturnSearch" %>
            ...
            <tr>
                <td style="height: 23px;" align="center" width="100%">
                  ...
                  <asp:TextBox ID="txtKey" runat="server"></asp:TextBox>
                    <asp:Button ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="搜索" Width="55px" />
                    &nbsp; &nbsp;
