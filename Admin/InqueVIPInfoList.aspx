<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InqueVIPInfoList.aspx.cs" Inherits="Admin_InqueVIPInfoList" %>
...
<table border="0" align="center" cellpadding="5" cellspacing="1"  style="width: 100%">
  ...
  <tr bgcolor="#0099cc" >
    <td colspan="2" style="height: 25px"><div align="center" style="color: #ffffff">
        <h4>
            会员信息查询<asp:Label ID="Label1" runat="server" ForeColor="Red"></asp:Label></h4></div></td>
  </tr>
    <tr >
        <td colspan="2" style="height: 100%">
            <table align="center"  border="0" cellpadding="5" cellspacing="1"
                ...
                <tr >
                    ...
                    <asp:GridView ID="gvVIPInfo" runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True"  CellPadding="4" GridLines="None" OnRowDeleting="gvVIPInfo_RowDeleting">
                        <Columns>
