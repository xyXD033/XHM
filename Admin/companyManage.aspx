                ...
                <tr >
                    <td align="left" style="height: 100%">
                        <asp:GridView ID="gvCompany" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            OnPageIndexChanging="gvCompany_PageIndexChanging" OnRowDeleting="gvCompany_RowDeleting"
                            Width="100%">
                            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                            <Columns>
                                <asp:BoundField DataField="Name" HeaderText="开发公司名称" />
                                <asp:TemplateField HeaderText="修改">
                                    <ItemTemplate>
                                               <a href="#" class="huise1" onclick="window.open('AddCompany.aspx?id=<%#Eval("id") %>','','width=300,height=300')">修改</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
