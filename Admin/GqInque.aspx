<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GqInque.aspx.cs" Inherits="Admin_GqInque" %>
        ...
        <td colspan="2" style="height: 100%">
            ...
            <tr>
                <td style="height: 122px">
                    <asp:GridView ID="gvgqCardRent" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnPageIndexChanging="gvgqCardRent_PageIndexChanging" PageSize="10">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="VIPName" HeaderText="会员名称" />
                                <asp:BoundField DataField="gqdate" HeaderText="过期天数" />
